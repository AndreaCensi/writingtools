...
\hline
 &  & \\ 
 \multicolumn{3}{l}{{\color[rgb]{0.5,0.5,0.5}\texttt{basic/partialorders}} \emph{Partial orders}}\\ 
 \hline
...
\fbox{%
\color[rgb]{0.5,0.5,0.5}\begin{minipage}[]{8cm}%
The upper sets of P are $\upsets(P)$\par%
{\small{\texttt{The upper sets of P are \$\textbackslash upsets(P)\$}}}\end{minipage}%
}% fbox
}% setlength
\\ 
