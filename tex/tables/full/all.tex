context /data/work/scm/environments/env_jbds/docs/writingtools/tex 
context /data/work/scm/environments/env_jbds/docs/writingtools/tex 
context /data/work/scm/environments/env_jbds/docs/writingtools/tex 
context /data/work/scm/environments/env_jbds/docs/writingtools/tex 
context /data/work/scm/environments/env_jbds/docs/writingtools/tex 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash veh}} & $\veh$ &  A vehicle body\\ 
 ...
 \hline
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash ygneig}} & $\ygneig$ &  A neighborhoood of $\ygoal$.\\ 
  &  & \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash AC\{...\}}} &  &  Marker for sections to write\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash citexx}} & $\citexx$ & \\ 
...
{\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash obsip}} & $\obsip$ &  Inner product bilinear form.\\ 
 ...
 {\color[rgb]{0.5,0.5,0.5}\texttt{\textbackslash posEl}} & $\posEl$ &  Position in the world frame.\\ 
